# -*- coding: utf-8 -*-
{
    ...
    'summary': """
        Automated Payroll and HR system customized for Kenya, with Ke reports and automated Tax Returns """,
    ...
    'depends': ['hr_contract', 'account', 'hr_payroll_account', 'send_payslips_by_email', 'attachment_indexation',
