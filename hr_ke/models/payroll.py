...
class HrPayslip(models.Model):
    ...
    def _compute_basic_net(self):
        line_values = (self._origin)._get_line_values(['P010', 'P120'])
        for payslip in self:
            payslip.basic_wage = line_values['P010'][payslip._origin.id]['total']
            payslip.net_wage = line_values['P120'][payslip._origin.id]['total']
